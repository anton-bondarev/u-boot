...
#elif defined(CONFIG_PPC470S) || defined(CONFIG_PPC470S_BM18) // ??? CONFIG_PPC470S_BM18
...
#if !defined(CONFIG_X86) && !defined(CONFIG_ARM) && !defined(CONFIG_ARM64) && !defined(CONFIG_PPC470S) && !defined(CONFIG_PPC470S_BM18)
	gd = new_gd;
#endif
