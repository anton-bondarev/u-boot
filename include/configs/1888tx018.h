...
#define 1888TX018_IM0_START           CONFIG_SPL_TEXT_BASE
#define 1888TX018_IM0_SIZE            (0x40000)

#define 1888TX018_SPL_STACK_SIZE 0x4000
#define CONFIG_SYS_SPL_MALLOC_SIZE  0x2000

/* stack for first processor 0x0043C000 */
#define CONFIG_SPL_STACK        (1888TX018_IM0_START + 1888TX018_IM0_SIZE - 1888TX018_SPL_STACK_SIZE)

#define 1888TX018_SPL_SPINTABLE_SIZE 32

#define 1888TX018_SPL_SPINTABLE (1888TX018_IM0_START + 1888TX018_IM0_SIZE - 1888TX018_SPL_SPINTABLE_SIZE)

/* stack for second processor 0x043FFFE0 */
#define 1888TX018_SPL_STACK_SECONDARY   (1888TX018_SPL_SPINTABLE)


/* dual stack size for second CPU */
#define CONFIG_SYS_SPL_MALLOC_START ((CONFIG_SPL_STACK - 1888TX018_SPL_STACK_SIZE*2) \
...
#define 1888TX018_SPL_FDT_MAX_LEN 0x1000
#define 1888TX018_SPL_ADDR_LIMIT (CONFIG_SYS_INIT_RAM_ADDR - 1888TX018_SPL_FDT_MAX_LEN)
