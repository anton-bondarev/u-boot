...
{
    spintable_entry* spintable = (spintable_entry*) (MPW_SPL_SPINTABLE | 0x40000000);
    ...
    tlb47x_map(spintable->entry_addr&(~0x0FFFFFFF), 0x00000000, 0x2, TLBSID_256M);
...
int process_spintable (void)
{
    ...
    tlb47x_map(0x01000000000, 0x40000000, 0x4, TLBSID_1M);
